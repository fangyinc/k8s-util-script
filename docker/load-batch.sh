#!/bin/bash
# COPY FROM rancher
# https://docs.rancher.cn/docs/rancher2.5/installation/other-installation-methods/air-gap/populate-private-registry/_index

images="batch-images.tar.gz"
list="batch-images.txt"
windows_image_list=""
windows_versions="1809"
# project name
# image: pause:1.28 => batch/pause:1.28
# bitnami/etcd:3.4.15 => bitnami/etcd:3.4.15
project="batch"
usage () {
    echo "USAGE: $0 [--images batch-images.tar.gz] --registry my.registry.com:5000"
    echo "  [-l|--image-list path] text file with list of images; one image per line."
    echo "  [-i|--images path] tar.gz generated by docker save."
    echo "  [-r|--registry registry:port] target private registry:port."
    echo "  [-p|--project batch] default project name"
